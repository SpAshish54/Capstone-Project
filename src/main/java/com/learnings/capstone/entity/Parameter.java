...
public class Parameter {
	...
	public String toString() {
		String featureString = (feature != null)
				? feature.toString()
				: "Feature{id=null, name='null', internalName='null', details='null'}";
	
		String productString = (feature != null && feature.getProduct() != null)
				? feature.getProduct().toString()
